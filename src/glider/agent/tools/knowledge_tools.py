    ...
    ToolDefinition(
        ...
        parameters={
            ...
            "properties": {
                "node_type": {
                    "type": "string",
                    "description": "Type of node to explain"
                }
            },
            "required": ["node_type"]
        }
...
NODE_DOCS = {
    ...
    "EndExperiment": {
        ...
        "category": "Experiment",
        "inputs": [
            {"name": "exec", "type": "execution", "description": "Triggers the end of the experiment"}
        ],
        "outputs": [],
        "properties": [],
        "tips": [
    ...
    "Delay": {
        ...
        "inputs": [
            ...
            {"name": "duration", "type": "number", "description": "Duration in milliseconds (optional, overrides property)"}
        ],
        "outputs": [
            {"name": "exec", "type": "execution", "description": "Triggers after delay completes"}
        ],
        "properties": [
            {"name": "delay_ms", "type": "number", "default": 1000, "description": "Delay duration in milliseconds"}
        ],
        "tips": [
    ...
    "Loop": {
        ...
        "inputs": [
            ...
            {"name": "count", "type": "number", "description": "Number of iterations (optional, overrides property)"}
        ],
        "outputs": [
            {"name": "body", "type": "execution", "description": "Triggers for each iteration"},
            {"name": "complete", "type": "execution", "description": "Triggers when all iterations are done"},
            {"name": "index", "type": "number", "description": "Current iteration index (0-based)"}
        ],
        "properties": [
            {"name": "iterations", "type": "number", "default": 10, "description": "Number of times to repeat"}
        ],
        "tips": [
    ...
    "DigitalWrite": {
        ...
        "inputs": [
            ...
            {"name": "value", "type": "boolean", "description": "Value to write (optional, overrides property)"}
        ],
        "outputs": [
        ...
        "properties": [
            ...
            {"name": "value", "type": "boolean", "default": True, "description": "HIGH (true) or LOW (false)"}
        ],
        "tips": [
    ...
    "DigitalRead": {
        ...
        "outputs": [
            ...
            {"name": "value", "type": "boolean", "description": "The read value (true = HIGH, false = LOW)"}
        ],
        "properties": [
    ...
    "PWMWrite": {
        ...
        "properties": [
            {"name": "device_id", "type": "string", "description": "ID of the device to control"},
            {"name": "value", "type": "number", "default": 128, "description": "PWM duty cycle (0-255)"}
        ],
        "tips": [
    ...
    "basic": [
        {
            ...
            "nodes": ["StartExperiment", "Loop", "DigitalWrite (HIGH)", "Delay (500)", "DigitalWrite (LOW)", "Delay (500)", "EndExperiment"],
            "requirements": ["Arduino with LED on pin 13"],
        },
        {
            "name": "Button LED",
            "description": "Turns LED on when button is pressed",
            "nodes": ["StartExperiment", "Loop", "DigitalRead", "Branch", "DigitalWrite (HIGH)", "DigitalWrite (LOW)"],
    ...
    async def _execute_suggest_flow(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "blink" in task_lower or "flash" in task_lower:
            suggestion["suggested_nodes"].extend([
                ...
                {"type": "DigitalWrite", "properties": {"value": True}, "reason": "Turn LED on"},
                {"type": "Delay", "properties": {"delay_ms": 500}, "reason": "Wait with LED on"},
                {"type": "DigitalWrite", "properties": {"value": False}, "reason": "Turn LED off"},
                {"type": "Delay", "properties": {"delay_ms": 500}, "reason": "Wait with LED off"},
            ])
        ...
        if "sensor" in task_lower or "read" in task_lower:
            suggestion["suggested_nodes"].extend([
                ...
                {"type": "Delay", "properties": {"delay_ms": 100}, "reason": "Polling interval"},
            ])
